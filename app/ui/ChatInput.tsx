    ...
    >
      ...
      <div 
        ...
        style={{ 
          ...
          boxShadow: '0 0 3px rgba(0, 0, 0, 0.05), 0 0 15px rgba(0, 0, 0, 0.05)'
        }}
      >
          ...
          >
            <div className={`flex items-center ${isMobile ? 'gap-1' : 'gap-2'}`}>
              ...
              <button
                ...
                aria-label="附加"
              >
                <svg width={isMobile ? "16" : "18"} height={isMobile ? "16" : "18"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="stroke-2">
              ...
              <button
                ...
                className={`inline-flex items-center justify-center gap-2 rounded-full transition-all duration-200 cursor-pointer border shadow-sm hover:shadow-md ${isMobile ? 'h-9 px-3 text-xs' : 'h-10 px-4 text-sm'}`}
                style={{
              ...
              >
                <svg width={isMobile ? "14" : "16"} height={isMobile ? "14" : "16"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="stroke-2">
